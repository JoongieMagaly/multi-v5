		...
		<div id="topbar">
			<div id="topnav">
				<ul>
					...
					<a href="/misEntregas">Mis Entregas</a>
					<br>
					<a href="/permisod">Ver Pedidos</a>
					<br>
		...
		<div id="featured_intro">
			...
			<table BORDER id="tab">
				...
				<form action="/mandar" method="get">
				    <td><%=pedido.getKey()%><br>
				    	Boleta Nº<input type="text" name="c" value="<%=pedido.getNum()%>">
				    </td>
					...
					<td><input type="submit" name="entregado" value="Entregado"></td>
				</form>
				</tr>
				<%
					}
