...
<%
List<Integer> numeros = (ArrayList<Integer>)request.getAttribute("numeros");
%>
</head>
<body id="top">
      ...
      <div class="text">
    	...
    	<table style="width:80%" border="1">
  		...
  		<tr>
    		...
    		<td>Entera</td> 
    		 ...
    		 <td><input type="checkbox" id="<%=comprar%>" name="<%=comprar%>" value="compra" onclick="seleccionar(<%=c%>)" checked>Comprar</td>
    		 <%}else{ %>
    		 <td>
    		 	S/.<input type="text" id="<%=precio%>" name="<%=precio%>" value="3.50" disabled size="4">
    		 	<input type="number" id="<%=peso%>" name="<%=peso%>" min="1" disabled>  
    	...
    	<tr><%c++; %>
    		...
    		<%esta = false;
    		 ...
    		 <td>
    		 <input type="checkbox" id="<%=comprar%>" name="<%=comprar%>" value="compra" onclick="seleccionar(<%=c%>)" checked>Comprar</td>
    		<%}else{ %>
    		 <td>
    		 	S/.<input type="text" id="<%=precio%>" name="<%=precio%>" value="5.00" disabled size="4">
    		 	<input type="number" id="<%=peso%>" name="<%=peso%>" min="1" disabled>  
    		 ...
    		 <td>
    		 <input type="checkbox" id="<%=comprar%>" name="<%=comprar%>" value="compra" onclick="seleccionar(<%=c%>)">Comprar</td>
    		<%} %>
    		 <td>S/.<input type="text" id="<%=monto%>" name="<%=monto%>" value="0" disabled size="4"></td>
    	</tr>
    	<tr>
    	...
    	<tr><%int d = c; %>
  		...
  		<tr>
    		...
    		<td><input type="button" value="ver total" onclick="sumar2()"></td>
