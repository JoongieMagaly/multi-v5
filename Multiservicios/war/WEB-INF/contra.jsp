...
<form action="/cambioc" method="post"><br><br>
Ingresa tu nueva Contraseña:<br><br>
<input type="password" name="contras" value=""><br>

<td><input type="submit" name="conf" value="Confirmar"></td>
</form>
</div>
</body>
</html>